  ...
  return [
    ...
    },
    {
      ...
      render: () =>
        createElement(
          Alert,
          { color: 'blue', title: 'Safe transfer admission' },
    ...
    },
    {
      ...
      label: 'Dynamic transfer limiter',
      description:
        'Disable only to use the explicit manual active-job limit. Queue bounds and per-instance serialization remain active.',
      colSpan: 'full',
      advanced: true,
    },
    {
    ...
    },
    {
      ...
      label: 'Maximum queued jobs per database',
      props: { min: 1, max: 256 },
      advanced: true,
    },
    {
      ...
      description: 'The actual concurrency limit while the dynamic limiter is disabled.',
    ...
    },
    {
      ...
      description: '0 derives the hard memory budget from live host/cgroup limits; otherwise use 128–16,777,216 MiB.',
    ...
    },
    {
      ...
      description: '0 derives the concurrency weight budget from live host/cgroup CPU limits.',
    ...
    },
    {
      ...
      label: 'Memory starvation timeout (seconds)',
      description: 'A job waiting for auto-detected memory is rejected after this time if headroom does not recover.',
    ...
    {
      type: 'number',
      name: 'config.security.clickhousePidsLimit',
      label: t('admin.nodeConfig.clickhousePidsLimit', {}),
      advanced: true,
    },
    {
      type: 'switch',
