  ...
  const run = async (operation: () => Promise<unknown>) => {
    try {
      ...
      if (failure.requiresReconciliation) {
        await queryClient.invalidateQueries({ queryKey: databasesEverywhereQueryKey(server.uuid) });
      }
      addToast(
      ...
      <ContextMenu
        items={[
          ...
          },
          {
            ...
            color: 'gray',
            canAccess: canPower,
            disabled: mutationBlocked || (!policy.start && !policy.restart && !policy.stop && !policy.kill),
            items: [
              {
                type: 'action',
                icon: faPlay,
                ...
                color: 'gray',
                disabled: mutationBlocked || !policy.start,
              ...
              },
              {
                ...
                color: 'gray',
                disabled: mutationBlocked || !policy.restart,
              ...
              },
              {
                ...
                label: t('server.stop', {}),
                color: 'gray',
                disabled: mutationBlocked || !policy.stop,
              ...
              },
              {
                ...
                label: t('server.kill', {}),
                color: 'red',
                disabled: mutationBlocked || !policy.kill,
          ...
          },
          {
            ...
            color: 'gray',
            canAccess: canUpdate,
            disabled: mutationBlocked || !policy.reconcile,
          },
          {
            type: 'action',
            icon: faLock,
            ...
            disabled: mutationBlocked || !policy.resetCredential,
          },
          ...
          >
            ...
            <TableData>
              <div>
                ...
                {mutationBlocked && database.mutation_block_reason && (
                  <Text size='xs' c='yellow' mt={3} lineClamp={1} title={database.mutation_block_reason}>
                    Read-only: {database.mutation_block_reason}
                  </Text>
                )}
              </div>
            </TableData>
