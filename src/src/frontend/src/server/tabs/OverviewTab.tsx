        ...
        <ServerCan action='databases-everywhere.power'>
          <Group gap='xs'>
            <Button
              ...
              disabled={!database.mutations_allowed || action !== null || !policy.start}
            ...
            <Button
              ...
              variant='default'
              loading={action === 'stop'}
              disabled={!database.mutations_allowed || action !== null || !policy.stop}
            ...
            <Button
              ...
              disabled={!database.mutations_allowed || action !== null || !policy.restart}
            ...
            <Button
              ...
              variant='light'
              loading={action === 'kill'}
              disabled={!database.mutations_allowed || action !== null || !policy.kill}
